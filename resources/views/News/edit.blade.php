...
<form action="/news/{{$pot->unique_news_id}}" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="news_short_discription" placeholder="short text"value="{{$pot->news_short_discription}}">
    <input type="text" name="news_long_discription" placeholder="long text" value="{{$pot->news_long_discription}}">
    <input type="file" name="new_image" value="image" value="{{$pot->}}">
